...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    if (id) {
      fetch(`${API_URL}/products/by-id/${id}`)
        .then((r) => r.json())
        .then((data) => {
  ...
  if (loading) {
    return (
      <div className="container py-5"><div className="text-center"><div className="spinner-border text-warning"></div></div></div>
    );
  }
  ...
  if (!product) {
    return (
      <div className="container py-5 text-center">
        ...
        <Link href="/" className="btn btn-amazon mt-3">Go Home</Link>
      </div>
    );
  }
          ...
          <div className="col-lg-4">
            <div className="product-info">
              ...
              <div className="rating-section">
                ...
                <span className="sold-count">1K+ bought</span>
              </div>
              ...
              <div className="features-list">
                <div className="feature-item">
                  ...
                  <div>
                    ...
                    <small>Order within 2 hrs 30 mins</small>
                  </div>
                </div>
                <div className="feature-item">
                  ...
                  {activeTab === "description" ? (
                    ...
                    <div className="specs-table">
                      <div className="spec-row">
                        ...
                        <span className="spec-value">{product.brand || "Amazon Basics"}</span>
                      </div>
                      <div className="spec-row">
